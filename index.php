  ...
  <div class="relative isolate overflow-hidden bg-gray-900">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-24 sm:pb-32 lg:flex lg:px-8 animate-fade">
      <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 mt-9">
        ...
        <p class="mt-6 text-lg leading-8 text-gray-300">Hello, I'm Tom Bugada. With more than four years of experience, I specialize in creating efficient HTML, CSS, and JavaScript websites, but also flutter apps and backends. I am passionate about web and app development as well as servers and datacenters.</p>
